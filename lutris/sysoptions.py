...
def get_gpu_vendor_cmd(nvidia_files):
    ...
    if USE_DRI_PRIME == 1:
        ...
        glxinfocmd = (
            "__GLX_VENDOR_LIBRARY_NAME=nvidia glxinfo | grep -i opengl | grep -i vendor"
        )
    return glxinfocmd
...
def get_vk_icd_choices():
    ...
    with subprocess.Popen(glxinfocmd,
                          shell=True,
                          stdout=subprocess.PIPE,
                          stderr=subprocess.STDOUT) as glxvendorget:
    ...
    if "Intel" in default_gpu:
        ...
        choices = [(_("Auto: AMD RADV Open Source (MESA: RADV)"),
                    amdradv_files)]
...
system_options = [  # pylint: disable=invalid-name
    ...
    },
    {
        ...
        "string",
        "label":
        _("Restrict number of cores to"),
        "advanced":
        True,
        "default":
        "1",
        "help":
        _("Maximum number of CPU cores to be used, if 'Restrict number of cores used' is turned on."
          ),
    },
    {
        "option":
    ...
    },
    {
        ...
        or system.find_executable("pipewire-pulse"),
        "help":
    ...
    },
    {
        ...
        "bool",
        "default":
        linux.LINUX_SYSTEM.gamemode_available(),
        "condition":
        linux.LINUX_SYSTEM.gamemode_available(),
        "label":
    ...
    },
    {
        ...
        get_output_choices,
        "condition":
        linux.LINUX_SYSTEM.display_server != "wayland",
        "default":
        "off",
        "advanced":
        True,
